...
class PostView(APIView): #resource that can be consumed - get and post
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serialiser.is_valid(): #check if the serialised data is valid
            ...
            return Response(serialiser.data) #return the serialised data with status code 201
        return Response(serialiser.errors) #return the errors with status code 400
